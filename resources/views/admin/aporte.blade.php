            ...
            @if(count($aportes)>0)
                <table class="table table-secondary table-striped">
                    <thead>
                        <tr>
                            ...
                            <th style="background: #0d6efd;" class="text-white text-center" scope="col">Socio</th>
                    ...
                    <tbody>
                        @foreach ($aportes as $aporte)
                            <tr>
                                ...
                                <th>{{ $aporte->nombres_usuario }} {{ $aporte->apellidos_usuario }}</th>
                ...
                <nav>
                    <ul class="pagination">
                        ...
                        @else
                            <li class="page-item">
                                <a class="page-link" href="{{ env('APP_URL') }}/aportesadmin/1">&lt;&lt;</a>
                            </li>
                            <li class="page-item">
                                <a class="page-link" href="{{ env('APP_URL') }}/aportesadmin/{{ $pagina-1 }}">&lt;</a>
                            </li>
                        @endif
                        @for ($i = $inicioPaginacion; $i <= $finalPaginacion; $i++)
                            ...
                            @else
                                <li class="page-item"><a class="page-link" href="{{ env('APP_URL') }}/aportesadmin/{{ $i }}">{{ $i }}</a></li>
                            @endif
                        @endfor
                        ...
                        @else
                            ...
                            <li class="page-item">
                                <a class="page-link" href="{{ env('APP_URL') }}/aportesadmin/{{ $totalPaginas }}">&gt;&gt;</a>
                            </li>
                        @endif
                    </ul>
                </nav>
