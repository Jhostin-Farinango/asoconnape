...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8 d-flex align-items-center">
            <div class="col-md-12">
                <h1>Editar Cantón: {{ $canton[0]->nombre_canton }}</h1>
            </div>
        </div>
            ...
            <form>
                <div class="row mb-3">
                    <div class="col-6">
                        ...
                        <input type="text" class="form-control" id="nombre" value="{{ $canton[0]->nombre_canton }}">
                    </div>
                    <div class="col-6">
                        ...
                        <select class="form-select" id="provincia">
                            ...
                            @foreach ($provincias as $provincia)
                                @if($canton[0]->id_provincia==$provincia->id_provincia)
...
<script type="text/javascript">
    ...
    function guardar(){
        ...
        if(validar()==false){
            ...
            let id="{{ $canton[0]->id_canton }}";
            let nombre=document.getElementById("nombre").value;
            let provincia=document.getElementById("provincia").value;
            axios.post(server+'/api/editarcanton', {
                id: id,
                nombre: nombre,
                provincia: provincia
            })
