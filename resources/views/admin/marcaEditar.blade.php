...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8 d-flex align-items-center">
            <div class="col-md-12">
                <h1>Editar Marca: {{ $marca[0]->nombre_marca }}</h1>
            </div>
        </div>
        <div class="col-md-8 mt-3">
            <form>
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="nombre" value="{{ $marca[0]->nombre_marca }}">
                </div>
                <div class="d-flex justify-content-center">
                    <button type="button" class="btn btn-primary me-2" id="btnguardar" onclick="guardar()">Guardar</button>
                    <a class="btn btn-md btn-danger ms-2" href="{{ env('APP_URL') }}/marcas" role="button">Cancelar</a>
                </div>
            </form>
        </div>
    </div>
...
<script type="text/javascript">
    ...
    function guardar(){
        ...
        if(validar()==false){
            ...
            let id="{{ $marca[0]->id_marca }}";
            let nombre=document.getElementById("nombre").value;
            axios.post(server+'/api/editarmarca', {
                id: id,
                nombre: nombre
            })
