...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8 d-flex align-items-center">
            <div class="col-md-12">
                <h1>Editar Provincia: {{ $provincia[0]->nombre_provincia }}</h1>
            </div>
        </div>
        <div class="col-md-8 mt-3">
            <form>
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="nombre" value="{{ $provincia[0]->nombre_provincia }}">
                </div>
                <div class="d-flex justify-content-center">
                    <button type="button" class="btn btn-primary me-2" id="btnguardar" onclick="guardar()">Guardar</button>
                    <a class="btn btn-md btn-danger ms-2" href="{{ env('APP_URL') }}/provincias" role="button">Cancelar</a>
                </div>
            </form>
        </div>
    </div>
...
<script type="text/javascript">
    ...
    function guardar(){
        ...
        if(validar()==false){
            ...
            let id="{{ $provincia[0]->id_provincia }}";
            let nombre=document.getElementById("nombre").value;
            axios.post(server+'/api/editarprovincia', {
                id: id,
                nombre: nombre
            })
