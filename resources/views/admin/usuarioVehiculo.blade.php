...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8 d-flex align-items-center">
            <div class="col-md-11">
                <h1>Vehículos de {{ $usuario[0]->nombres_usuario }} {{ $usuario[0]->apellidos_usuario }}</h1>
            </div>
            <div class="col-md-1 d-flex justify-content-center">
                <a class="btn btn-md btn-primary" href="{{ env('APP_URL') }}/agregarvehiculosocio/{{ $usuario[0]->id_usuario }}" role="button">Nuevo</a>
            </div>
        </div>
            ...
            @if(count($vehiculos)>0)
                ...
                <nav>
                    <ul class="pagination">
                        ...
                        @else
                            <li class="page-item">
                                <a class="page-link" href="{{ env('APP_URL') }}/vehiculosocio/{{ $usuario[0]->id_usuario }}/1">&lt;&lt;</a>
                            </li>
                            <li class="page-item">
                                <a class="page-link" href="{{ env('APP_URL') }}/vehiculosocio/{{ $usuario[0]->id_usuario }}/{{ $pagina-1 }}">&lt;</a>
                            </li>
                        @endif
                        @for ($i = $inicioPaginacion; $i <= $finalPaginacion; $i++)
                            ...
                            @else
                                <li class="page-item"><a class="page-link" href="{{ env('APP_URL') }}/vehiculosocio/{{ $usuario[0]->id_usuario }}/{{ $i }}">{{ $i }}</a></li>
                            @endif
                        @endfor
                        ...
                        @else
                            ...
                            <li class="page-item">
                                <a class="page-link" href="{{ env('APP_URL') }}/vehiculosocio/{{ $usuario[0]->id_usuario }}/{{ $totalPaginas }}">&gt;&gt;</a>
                            </li>
                        @endif
                    </ul>
                </nav>
...
<script type="text/javascript">
    ...
    function eliminar(){
        ...
        axios.post(server+'/api/eliminarvehiculousuario', {
            id: id,
            usuario: usuario
        })
